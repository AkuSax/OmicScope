...
def preprocess_and_export(output_dir="web_demo/data"):
    ...
    # CRITICAL STEP: Scale the spatial coordinates to match the image
    # We multiply the original coordinates by the scale factor we found earlier
